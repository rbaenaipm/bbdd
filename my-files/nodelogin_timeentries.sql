...
CREATE TABLE `timeentries` (
  ...
  PRIMARY KEY (`entryId`),
  KEY `timeentries_FK_idx` (`tasks_taskId`),
  CONSTRAINT `timeentries_FK` FOREIGN KEY (`tasks_taskId`) REFERENCES `tasks` (`taskId`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Dump completed on 2023-01-18 10:04:02
